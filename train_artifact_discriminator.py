...
from videoseal.quality_metric.watermark_generators import FFTWatermarkWaves, FFTWatermarkGaussian, FFTWatermarkLines
...
def get_parser():
    ...
    aa("--image_dataset", type=str, 
        help="Name of the image dataset.", default="sa-1b-full-resized")
    aa("--video_dataset", type=str,
        help="Name of the video dataset.", default="none") #default="sa-v")
    ...
    aa("--embedder_list", type=str, default="baseline/trustmark,baseline/cin,baseline/wam,baseline/mbrs,baseline/hidden,videoseal_0.0")
    aa("--embedder_list_valid", type=str, default="videoseal_1.0")
    ...
    aa('--batch_size_video_eval', default=1, type=int, help='Batch size for evaluation')
...
def main(params):
    ...
    embedder_valid = setup_model_from_checkpoint(embedder_list_valid[embedder_list_valid_idx]).to(device)
    ...
    if params.modality == Modalities.IMAGE:
        ...
        train_loader = get_video_dataloader(params.video_dataset_config.train_dir,
        ...
        val_loader = get_video_dataloader(params.video_dataset_config.val_dir,
