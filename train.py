...
With video compression aug:
    ...
    OMP_NUM_THREADS=40 torchrun --nproc_per_node=2 train.py --local_rank 0 --attenuation jnd_1_1 --balanced False  --total_gnorm 1.0 --scaling_w_schedule Cosine,scaling_min=0.016,start_epoch=50,epochs=100 --scaling_w 0.5 --scaling_i 1.0 --nbits 96 --lambda_dec 1.0 --lambda_det 0.0 --lambda_d 0.1 --lambda_i 0.1 --perceptual_loss yuv --seed 444  --optimizer AdamW,lr=1e-5 --resume_from /checkpoint/pfz/2025_logs/0214_vseal_rgb_96bits_scalingw_schedule/_scaling_w_schedule=0_scaling_w=0.2_perceptual_loss=yuv/checkpoint_inflated.pth --saveimg_freq 50 --eval_freq 10 --full_eval_freq 50 --batch_size_video_eval 1 --batch_size_video 1 --batch_size_eval 8 --batch_size 16 --workers 0 --iter_per_valid 10 --videowam_step_size 1 --resume_disc True --finetune_detector_start 0 --video_start 0 --prop_img_vid 0.0 --epochs 201 --iter_per_epoch 1000 --img_size_proc 256 --img_size_val 768 --img_size 768 --extractor_model sam_small_temporal --embedder_model unet_small2_quant_conv3d --augmentation_config configs/all_augs_v2.yaml --video_dataset sa-v --image_dataset none
    OMP_NUM_THREADS=40 torchrun --nproc_per_node=2 train.py --local_rank 0 --attenuation none --balanced False  --total_gnorm 1.0 --scaling_w 0.016 --scaling_i 1.0 --nbits 128 --lambda_dec 1.0 --lambda_det 0.0 --lambda_d 0.1 --lambda_i 0.1 --perceptual_loss yuv --seed 444  --optimizer AdamW,lr=1e-5 --resume_from /checkpoint/pfz/2025_logs/0219_vseal_convnextextractor/_nbits=128_lambda_i=0.1_embedder_model=1/checkpoint600.pth --saveimg_freq 50 --eval_freq 10 --full_eval_freq 50 --batch_size_video_eval 1 --batch_size_video 1 --batch_size_eval 8 --batch_size 16 --workers 0 --iter_per_valid 10 --videowam_step_size 1 --resume_disc True --finetune_detector_start 1000 --video_start 0 --prop_img_vid 0.0 --epochs 201 --iter_per_epoch 1000 --img_size_proc 256 --img_size_val 448 --img_size 448 --extractor_model convnext_tiny --embedder_model unet_small2_yuv_quant --augmentation_config configs/all_augs_v2.yaml --video_dataset sa-v --image_dataset none --frames_per_clip 16
