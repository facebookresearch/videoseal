...
def get_parser():
    ...
    aa("--wam_wm_clamp", type=utils.bool_inst, default=True,
       help="internally clap the watermark generated by the model to (0,1) before multiplying by scaling_w")
