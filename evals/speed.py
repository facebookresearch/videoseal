...
--embedder_config configs/embedder.yaml --extractor_config configs/extractor.yaml
--embedder_model hidden --extractor_model hidden
--embedder_model unet_small --extractor_model sam_small
"""
