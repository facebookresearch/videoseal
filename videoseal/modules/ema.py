"""
This file contains the definition of the EMA class from https://github.com/markweberdev/maskbit/blob/main/modeling/modules/ema_model.py
"""
...
class EMAModel:
    ...
    def load_state_dict(self, state_dict: dict) -> None:
        ...
        if shadow_params is not None:
            ...
            for s_param, param in zip(self.shadow_params, shadow_params):
